  ...
  return (
    <div className="fixed inset-0 z-[200] pointer-events-none font-tajawal" dir="rtl">
      ...
      <motion.div
        ...
        className="absolute pointer-events-none rounded-2xl border-2 border-[#C8A96A]"
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className={`absolute pointer-events-auto rounded-[1.5rem] shadow-2xl border overflow-hidden
            ${theme === 'dark' ? 'bg-[#0d2d22] border-[#C8A96A]/30 text-white' : 'bg-white border-[#0F3D2E]/10 text-[#0F3D2E]'}
          `}
        ...
        >
          ...
          <div className="h-1 w-full bg-black/10">
            <motion.div
              ...
              className={`h-full ${theme === 'dark' ? 'bg-[#C8A96A]' : 'bg-[#0F3D2E]'}`}
            />
          </div>
          ...
          <div className="p-5">
            ...
            <div className="flex items-center gap-2 mb-3 mt-1 pr-1">
              <div className={`p-1.5 rounded-xl ${theme === 'dark' ? 'bg-[#C8A96A]/20 text-[#C8A96A]' : 'bg-[#0F3D2E]/10 text-[#0F3D2E]'}`}>
                <Sparkles size={16} />
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`px-5 py-2 rounded-xl font-bold text-sm transition-all hover:scale-105 active:scale-95 flex items-center gap-1.5
                    ${theme === 'dark' ? 'bg-[#C8A96A] text-[#0F3D2E]' : 'bg-[#0F3D2E] text-white'}
                  `}
                >
