    ...
    <div className={`min-h-[80vh] font-tajawal py-8 md:py-14 px-4`} dir="rtl">
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <h1 className={`text-3xl md:text-5xl font-bold mb-3 ${isDark ? 'text-[#d6a54a]' : 'text-[#0f1c2c]'}`}>
            نفحة يقين
          </h1>
          <p className={`text-base md:text-lg leading-relaxed opacity-75 max-w-md mx-auto ${isDark ? 'text-[#F5F5DC]' : 'text-[#0f1c2c]'}`}>
        ...
        <motion.div
          ...
          className={`rounded-[2rem] border shadow-xl overflow-hidden
            ${isDark ? 'bg-[#0c1622] border-[#d6a54a]/20' : 'bg-white border-[#0f1c2c]/10'}
          `}
        >
          {/* Tabs */}
          <div className={`flex border-b ${isDark ? 'border-[#d6a54a]/15' : 'border-[#0f1c2c]/10'}`}>
            {[
              ...
              return (
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 py-4 text-sm font-bold transition-all
                    ${active
                      ? (isDark ? 'bg-[#d6a54a]/15 text-[#d6a54a] border-b-2 border-[#d6a54a]' : 'bg-[#0f1c2c]/8 text-[#0f1c2c] border-b-2 border-[#0f1c2c]')
                      : (isDark ? 'text-[#F5F5DC]/50 hover:text-[#F5F5DC]/80' : 'text-[#0f1c2c]/40 hover:text-[#0f1c2c]/70')
                    }
                  `}
                >
                  <Icon size={16} />
          ...
          <div className="p-6 md:p-8 space-y-5">
            ...
            <div className="relative">
              <textarea
                ...
                className={`w-full resize-none rounded-2xl border px-4 py-3 text-base outline-none transition-all leading-relaxed
                  ${isDark
                    ? 'bg-[#0f1c2c]/50 border-[#d6a54a]/20 text-[#F5F5DC] placeholder-[#F5F5DC]/30 focus:border-[#d6a54a]/50'
                    : 'bg-[#f8faf9] border-[#0f1c2c]/15 text-[#0f1c2c] placeholder-[#0f1c2c]/30 focus:border-[#0f1c2c]/40'
                  }
                `}
              />
              <span className={`absolute bottom-3 left-3 text-xs opacity-40 ${isDark ? 'text-[#d6a54a]' : 'text-[#0f1c2c]'}`}>
                {message.length}/500
              </span>
            </div>
            ...
            <button
              ...
              className={`flex items-center gap-2 text-sm font-bold px-4 py-2.5 rounded-xl border transition-all hover:scale-105 active:scale-95
                ${isDark
                  ? 'border-[#d6a54a]/30 text-[#d6a54a] hover:bg-[#d6a54a]/10'
                  : 'border-[#0f1c2c]/25 text-[#0f1c2c] hover:bg-[#0f1c2c]/5'
                }
              `}
            >
              <Shuffle size={15} />
            ...
            <AnimatePresence>
              {activeTab === 'email' && (
                ...
                >
                  <label className={`block text-sm font-bold mb-1.5 ${isDark ? 'text-[#d6a54a]' : 'text-[#0f1c2c]'}`}>
                  ...
                  <input
                    ...
                    `}
                  />
                  <p className={`mt-1.5 text-xs opacity-50 ${isDark ? 'text-[#F5F5DC]' : 'text-[#0f1c2c]'}`}>
            ...
            {/* WhatsApp hint */}
            {activeTab === 'whatsapp' && (
              <p className={`text-xs leading-relaxed opacity-55 ${isDark ? 'text-[#F5F5DC]' : 'text-[#0f1c2c]'}`}>
            ...
            <motion.button
              ...
              className={`w-full py-4 rounded-2xl font-bold text-lg flex items-center justify-center gap-3 transition-all shadow-lg
                ${isDark
                  ? 'bg-[#d6a54a] text-[#0f1c2c] hover:bg-[#d4b97a] disabled:opacity-60'
                  : 'bg-[#0f1c2c] text-white hover:bg-[#0a2d22] disabled:opacity-60'
                }
              `}
            >
              {sending ? (
        ...
        <motion.p
          ...
          animate={{ opacity: 0.5 }}
          transition={{ delay: 1 }}
          className={`text-center text-sm mt-8 leading-relaxed ${isDark ? 'text-[#F5F5DC]' : 'text-[#0f1c2c]'}`}
        >
