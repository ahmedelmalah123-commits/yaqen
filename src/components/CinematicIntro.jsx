      ...
      {isVisible && (
        ...
        >
          ...
          <button 
            ...
            className="absolute bottom-8 right-8 z-50 px-6 py-2 rounded-full border border-[#C8A96A]/30 text-[#C8A96A] hover:bg-[#C8A96A]/20 transition-all font-cairo text-sm tracking-widest shadow-lg backdrop-blur-md"
          >
            تخطي
          </button>
          ...
          <div className="absolute inset-0 z-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#C8A96A]/20 via-[#0F3D2E]/60 to-[#0A1A14]"></div>

          {/* Atmospheric Glow */}
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
             <div className="w-[50vw] h-[50vw] bg-[#C8A96A]/10 blur-[150px] rounded-full animate-pulse"></div>
          </div>
          ...
          <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
            {[...Array(15)].map((_, i) => (
              <motion.div
                ...
                className="absolute w-1 h-1 bg-[#C8A96A] rounded-full blur-[1px]"
              />
            ))}
          </div>
          ...
          <motion.div
            ...
            className="absolute top-0 w-px bg-gradient-to-b from-transparent via-[#C8A96A] to-transparent shadow-[0_0_20px_rgba(200,169,106,1)]"
          />
